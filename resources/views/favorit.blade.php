                                ...
                                @foreach($wishlists as $wishlist)
                                    <div class="row gy-3 mb-4 border-bottom">
                                        <div class="col-lg-5">
                                            <div class="me-lg-5">
                                                <div class="d-flex">
                                                    <img src="{{ asset('storage/' . $wishlist->product->image_1) }}"
                                        ...
                                        <div
                                            ...
                                            <div class="ms-5">
                                                <text class="h6 text-decoration-line-through">Rp
                                                    {{ number_format($wishlist->product->original_price, 0, ',', '.') }}<span
                                        ...
                                        <div
                                            ...
                                            <div class="float-md-end">
                                                <a href="{{ route('cart.add', $wishlist->product->id) }}"
                                                    class="btn btn-success border px-2 icon-hover-primary">+ Keranjang</a>
